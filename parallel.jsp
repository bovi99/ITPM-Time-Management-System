...
<body>
    ...
    <div class="container-fluid pt-5">
     ...
     <center>               
        ...
        <input class="button button1" type="button" name="update" value="Consective">
		</a>    
		
		        
       	<a href="parallel.jsp">
        <input class="btn btn-primary btn-lg" type="button" name="update" value="Parallel">
		</a>
...
<br/>
	...
	<a href="non overlaping.jsp">
            <input class="button button1" type="submit" name="submit" value="Add Parallel">
            </a>
            &nbsp;
