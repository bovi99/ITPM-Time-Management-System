...
<title>Delete Lecture Location</title>
...
<div class="body-content">
  <div class="module">
    <h1>Delete Lecture Location Details</h1>
    <form class="form" action="updateServlet" method="post">
      <div class="alert alert-error"></div>
      <input type="text" placeholder="room" name="lecturer" value ="<%=room%>" required />
      <input type="text" placeholder="Time" name="time" value ="<%=time%>" required />
      <input type="text" placeholder="day" name="group" value ="<%=day%>" required />
      <input type="text" placeholder="endDay" name="subGroup" value ="<%=endDay%>" required />
