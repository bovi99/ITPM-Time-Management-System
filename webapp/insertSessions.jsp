...
<div class="body-content">
 ...
 <h2>Add Lecture,Group and Sub group</h2>
    <form class="form" action="Insert" method="post">
      <div class="alert alert-error"></div>
      
      <input type="text" placeholder="Lecturer" name="lecturer" required />
      <input type="text" placeholder="Time" name="time" required />
      <input type="text" placeholder="Group" name="group" required />
      <input type="text" placeholder="Sub Group" name="subGroup" required />
