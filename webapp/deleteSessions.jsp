...
<div class="body-content">
  <div class="module">
		      <h1>Sessions And Not Available Time Allocation</h1>
		 <h2>Delete Sessions Details</h2>

    <form class="form" action="updateServlet" method="post">
      <div class="alert alert-error"></div>
      <input type="text" placeholder="Lecturer" name="lecturer" value ="<%=id%>" required />
      <input type="text" placeholder="Time" name="time" value ="<%=time%>" required />
      <input type="text" placeholder="Group" name="group" value ="<%=group%>" required />
      <input type="text" placeholder="Sub Group" name="subGroup" value ="<%=subGroup%>" required />
      <input type="text" placeholder="Session ID" name="sessionID" value ="<%=sessionID%>" required />
      <div class="avatar"></div>




      <input type="submit" value="DELETE" name="register" class="btn btn-block btn-primary" />
    </form>
  </div>
</div>
</body>
