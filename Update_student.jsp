...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            ...
            <h1 class="display-4 m-0">  Update Student  Groups  
        </div>
        <div class="row justify-content-center">
            ...
            <input type="text" name="id_g" id="name" value="<%=id_S %>" size="22" required readonly><br/><br/>

           
        
        
            <label for="name">  Academic year Semester <span>*</span></label><br/>
            <input type="text" name="asem" id="name" value="<%=A_Y_S_S%>" size="22" required><br/><br/>

           

          
            <label for="text">   Student ID  <span>*</span></label><br/>
            <input type="text" name="sid" id="email" value="<%=S_ID_S%>" size="22" required><br/>
<br/>

          
           
            <label for="name"> Program  <span>*</span></label><br/>
            <input type="text" name="pro" id="name" value="<%=PRO_S%>" size="22" required><br/><br/>
<br/>

           
         
          <label for="name"> Group Number   <span>*</span></label><br/>
            <input type="text" name="gnu" id="name" value="<%=GR_NU_S%>" size="22" required><br/><br/>
<br/>

          
           
            <label for="name"> Sub Group Number<span>*</span></label><br/>
            <input type="text" name="sgn" id="name" value="<%=SU_GRU_NUM_S%>" size="22" required><br/><br/>
<br/>

           
          
            <label for="name">   Group ID <span>*</span></label><br/>
            <input type="text" name="gid" id="name" value="<%=CL_GR_ID_S%>" size="22" required><br/><br/>
<br/>


           <label for="name">   Sub Group ID   <span>*</span></label><br/>
            <input type="text" name="sgi" id="name" value="<%=S_G_ID_S%>" size="22" required><br/><br/>
<br/>
            ...
            <input class="button button1" type="submit" name="submit" value="Update">
            &nbsp;
