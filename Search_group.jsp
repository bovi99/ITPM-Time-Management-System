...
<style>
body  {
  background-image: url("file:///C:/Users/LENOVO/eclipse-workspace/Solro_university/src/main/webapp/img/itpm1.jpg");
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            ...
            <h1 class="display-4 m-0">  Search Groups  
        </div>
        <div class="row justify-content-center">
            ...
            <input type="text" name="GID" id="GID" value="" size="22" required><br/><br/>
...
<br/>
            ...
            <input class="button button1" type="submit" name="submit" value=" Search Group">
            &nbsp;
