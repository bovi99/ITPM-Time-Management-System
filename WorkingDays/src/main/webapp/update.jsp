...
body{
  ...
  background:url('http://clevertechie.com/img/bnet-bg.jpg');
}
...
String id =request.getParameter("id");
	...
	String noOf_WorkingDays =request.getParameter("noOf_WorkingDays");
...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" action="updateServlet" method="post">
      ...
      <input type="text" placeholder="ID" name="id" value ="<%=id%>" required />
      ...
      <input type="text" placeholder="No Of WorkingDays" name="workingdays" value ="<%=noOf_WorkingDays%>" required />
      <input type="text" placeholder="Weekdays" name="weekdays" value ="<%=weekDays%>" required />
      <input type="text" placeholder="Weekdays" name="weekend" value ="<%=weekEnd%>" required />
      <input type="text" placeholder="Hours" name="hours" value ="<%=hours%>" required />
      <input type="text" placeholder="Minutes" name="min" value ="<%=min%>" required />
      <div class="avatar"></div>
      <input type="submit" value="UPDATE" name="register" class="btn btn-block btn-primary" />
    </form>
  </div>
</div>
</body>
