...
<title>Insert Working Details</title>
</head><style>
*{  
  margin:0;
  padding:0;
...
<div class="body-content">
  <div class="module">
    <h1>ADD WORKING DAYS AND HOURS..</h1>
    <form class="form" action="Insert" method="post">
      <div class="alert alert-error"></div>
      
      <input type="text" placeholder="Username" name="username" required />
      <input type="password" placeholder="Password" name="password" required />
      <input type="text" placeholder="No Of Working Days" name="noOf_WorkingDays" required />
      <input type="text" placeholder="Weekdays" name="weekDays" required />
      <input type="text" placeholder="Weekend Days" name="weekEnd" required />
      <input type="text" placeholder="Hours" name="hours" required />
      <input type="text" placeholder="Minutes" name="min" required />
      <div class="avatar"></div>
      <input type="submit" value="ADD WORKING DAYS AND HOURS" name="register" class="btn btn-block btn-primary" />
    </form>
    <a href="login.jsp">
      	<input type="submit" value="HOME" name="register" class="btn btn-block btn-primary" />
    </a>
  </div>
</div>
