...
@WebServlet("/LecturerInsert")
public class LecturerInsert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue= LecturerDBUtil.insertLecturer(username, password, noOf_WorkingDays, weekDays, weekEnd, hours, min);
