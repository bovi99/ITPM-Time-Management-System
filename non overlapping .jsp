...
<body>
    ...
    <div class="container-fluid pt-5">
     ...
     <center>               
        ...
        <input class="btn btn-primary btn-lg" name="update" value="Non Overlaping">
		</a>    
                 <a href ="home.jsp">
...
<br/>
	...
	<a href="non available time.jsp">
            <input class="button button1" type="submit" name="submit" value="Add Session">
           </a>
            &nbsp;
